...
Metodología
Análisis exploratorio de datos (EDA): revisión de calidad de datos, clasificación de las 95 variables en categorías financieras, descripción detallada de las variables más relevantes, histogramas y boxplots interpretados.
Matriz de correlación: identificación de pares de variables con correlación > 0.8 (se conservan todas las variables, ya que los modelos usados son robustos a la multicolinealidad).
Validación cruzada estratificada de 10 folds (StratifiedKFold), aplicada de forma idéntica a los cinco modelos para una comparación justa.
Modelos entrenados:
